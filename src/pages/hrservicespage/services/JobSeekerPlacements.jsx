...
const JobSeekerPlacements = () => {
    const service = hrServiceDetails['hr-job-placements'];
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-200">
            <ServiceHero service={service} id="hr-job-placements" />
...
export default JobSeekerPlacements;
